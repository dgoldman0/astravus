...
The development chapter picker allows deliberate entry at any scene. It establishes completed earlier scenes and their encounters, resets the current history and rollback boundary, and resumes the ordinary story flow. The selected scene still delivers its own introductions and revelations. Jumping backward therefore removes later knowledge; it does not unlock the entire People guide. The preview includes this control in desktop and browser builds, independently of Ren'Py's developer-console setting.
