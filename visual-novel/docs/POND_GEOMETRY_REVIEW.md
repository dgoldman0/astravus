...
[garden-pond.png](../game/images/backgrounds/book-one/garden-pond.png). Its shallow
water, low irregular coping and adjacent ground define the geometry.
[garden-work-area.png](../game/images/backgrounds/book-one/garden-work-area.png)
...
The [location register](location-continuity.json) retains the seven pond findings
...
python3 scripts/graphics_review.py record game/images/backgrounds/book-one/garden-work-area.png \
  ...
  --evidence docs/POND_GEOMETRY_REVIEW.md \
