...
python3 scripts/graphics_review.py record game/images/cg/book-one/theme-path-friends.png \
  ...
  --evidence docs/graphics-cg-audit.md \
...
`build/archive/design-proof/`. Its 98 regular files and six symlinks were verified
...
mv visual-novel/build/archive/design-proof visual-novel/build/design-proof
