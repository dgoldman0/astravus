...
def main():
    ...
    test.add_argument("--suite", choices=("chapter_playthrough", "closing_theme_review", "character_framing_review", "glossary_review", "environment_grounding_review", "environment_state_review", "pond_state_review", "score_review"),
