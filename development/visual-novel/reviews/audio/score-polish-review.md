...
accompaniment patterns. The [cue sheet](../../../../visual-novel/docs/score-cue-sheet.md) ties those choices to
specific dialogue beats; the [catalog](../../../../visual-novel/docs/score-catalog.json) records their forms
