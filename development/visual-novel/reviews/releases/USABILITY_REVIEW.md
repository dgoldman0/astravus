...
| Help | The earlier shortcut/explanation concatenation was a real defect, despite passing functional assertions. A fixed 420px shortcut container with a 30px gap now gives every explanation the same start position. H and V are visibly separate from Hide and Toggle; longer mouse/keyboard labels also fit. The [1280 view](../../../../visual-novel/test-results/usability/1280x720-help.png) and [960 view](../../../../visual-novel/test-results/usability/960x540-help.png) have clear, unclipped rows and footer guidance. |
| Dialogue and quick bar | The solid background gives the larger italic dialogue good separation from the painting. Increasing quick-bar type from 21 to 26 virtual pixels makes labels about 13 screen pixels at 960px width, compared with roughly 10.5 before. All ten labels have distinct spacing and remain inside the window at [1280](../../../../visual-novel/test-results/usability/1280x720-large-solid-dialogue.png) and [960](../../../../visual-novel/test-results/usability/960x540-large-solid-dialogue.png). The larger labels neither crowd the dialogue nor overlap one another. |
