...
The generation prompts specify intended constraints; selection and in-game review assess the resulting artwork. This remains an alpha with limited expressions and poses. Verification results are recorded in [VALIDATION.md](../../../../visual-novel/docs/VALIDATION.md).
