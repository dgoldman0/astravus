...
**Start with the [visual review](lumen-study/review.html): annotated current VN images, anatomy drawings and an adjustable scale worksheet.** Open the HTML in a browser from this checkout. The [reference atlas](lumen-study/Reference-Atlas.md) and drawings below also work without the interactive page.
...
## A local section to take into Blender next
